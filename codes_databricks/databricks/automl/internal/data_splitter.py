...
class ClassificationDataSplitter(DataSplitter):
    def _train_test_split(self,
        ...
        if ensure_all_labels_present:
            ...
            for clas, num_rows in class_counts.items():
                target_sample_size = ClassificationStatsCalculator.PYSPARK_MIN_OUTPUT_ROWS_TO_INPUT_ROWS_MAP[
    ...
    def split(self,
        ...
        stats_calculator = ClassificationStatsCalculator(target_col=target_col, time_col=None)
        rem_class_counts = stats_calculator.get_class_counts(split_rem_df)
