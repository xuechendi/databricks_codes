...
from databricks.automl.shared.const import ClassificationTargetTypes, ProblemType
...
from databricks.automl.internal.sections.training.config import GlobalConfiguration
from databricks.automl.internal.sections.training.eval_plots import ClassificationEvaluationPlots
from databricks.automl.internal.sections.training.exit import IPykernelExit
from databricks.automl.internal.sections.training.inference import SklearnInference
from databricks.automl.internal.sections.training.input import LoadData
from databricks.automl.internal.sections.training.preprocess import ArrayPreprocessor, BooleanPreprocessor, \
...
from databricks.automl.internal.sections.training.shap import ShapFeatureImportancePlot
from databricks.automl.internal.sections.training.split import SplitData
from databricks.automl.internal.sections.training.split_by_col import SplitDataByCol
...
class SklearnPlanner(TrialPlanner):
    ...
    def __init__(self,
        ...
        :param metric: the name of the metric being optimized for, as it is recorded in trials
        ...
        self._has_feature_store_joins = preprocess_result.has_feature_store_joins
    ...
    def generate(self, hyperparameters: Dict[str, Any]) -> Plan:
        ...
        var_feature_spec_path = "feature_spec_path"
        ...
        var_sample_weight = "sample_weight"
        ...
        input_section = LoadData(
            ...
            var_feature_spec_path=var_feature_spec_path)
        ...
        if self._split_col:
            split_section = SplitDataByCol(
                ...
                var_sample_weight=var_sample_weight,
        ...
        inference_section = SklearnInference(
            var_run=self._var_run, has_feature_store_joins=self._has_feature_store_joins)
