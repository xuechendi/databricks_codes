...
from databricks.automl.legacy.const import DatasetFormat, Framework, MLFlowFlavor
...
from databricks.automl.legacy.sections.training.config import ForecastGlobalConfiguration
from databricks.automl.legacy.sections.training.exit import NotebookExit
from databricks.automl.legacy.sections.training.forecast import ProphetSection, ArimaSection
...
class ForecastPlanner(TrialPlanner):
    ...
    def __init__(self, var_target_col: str, var_time_col: str, var_id_cols: str, var_horizon: str,
        ...
        self._num_folds = preprocess_result.num_folds
